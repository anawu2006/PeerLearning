...
<div id="t3-mainbody" class="t3-mainbody two-sidebar">
	<div class="row equal-height">
		...
		<!-- SIDEBAR 1 -->
		<div class="t3-sidebar t3-sidebar-left col col-xs-6 col-md-3  col-md-pull-6 <?php $this->_c($vars['sidebar1']) ?>">
			<jdoc:include type="modules" name="<?php $this->_p($vars['sidebar1']) ?>" style="T3Xhtml" />
		</div>
		<!-- //SIDEBAR 1 -->
	
		<!-- SIDEBAR 2 -->
		<div class="t3-sidebar t3-sidebar-right col col-xs-6 col-md-3 <?php $this->_c($vars['sidebar2']) ?>">
