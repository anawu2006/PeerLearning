...
class KunenaTemplateJA_Platon extends KunenaTemplate {
	// Try to find missing files from the following parent templates:
	protected $default = array('ja_platon');
	...
	public function initialize() {
		KunenaFactory::loadLanguage('com_kunena.tpl_ja_platon');
		...
		$filename = JPATH_SITE . '/components/com_kunena/template/ja_platon/css/custom.css';
